      ...
      <nav className="navbar fixed-bottom bg-nav container-fluid">
          <div className="w-50 d-flex justify-content-left menu-1">
            <Link className={router.pathname == "/" ? "icon-nav active-nav" : "icon-nav"} href={'/'} aria-label="home">
              <Image src={`/navigation/${router.pathname === "/" ? "profile" : "profile-outline"}.png`} height='30' width='30' Priority className="icon-png" alt="navbarimg"></Image>
            </Link>
          </div>
          <div className="d-flex menu-2">
            ...
            <Image src={`/navigation/${router.pathname === "/projects" ? "project" : "project-outline"}.png`} height='30' width='30' Priority className="icon-png" alt="navbarimg"></Image>
            </Link>
          </div>
          <div className="d-flex justify-content-right menu-3">
            ...
            <Image src={`/navigation/${router.pathname === "/contact" ? "chat" : "chat-outline"}.png`} height='30' width='30' Priority className="icon-png" alt="navbarimg"></Image>
            </Link>
          </div>
      </nav>
    )
