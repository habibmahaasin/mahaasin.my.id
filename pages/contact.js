...
function Contact({ contactlist, title }) {
  ...
  return (
    <div className="contact-section">
      ...
      <p className="x-mini-title mt-3" align="justify">
        For <span>Hiring, Business, or Collaboration</span> please contact me
        via email or other social media bellows.
      </p>
              ...
              <div className="row align-middle">
                <div className="col-6 w-25 d-flex justify-content-center align-middle align-items-center">
                  <div className="image-container">
                    <Image
                      src={`/social-media/${contact.id}.svg`}
                      className="image"
                      height="100"
                      width="100"
                      alt={contact.name}
